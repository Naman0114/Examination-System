...
function Addtest() {
  ...
  const storeEncryptedIPFSHash = async (title, encryptedHash,contractInstance) => {
  ...
  const handleSubmit = async () => {
    ...
    await storeEncryptedIPFSHash(testData.title, result.data.ipfsHash,contractInstance);
